...
function loadHomePage(){
    $.ajax({
        ...
        success: function(data){
            ...
            $("#container").html('<div style="margin-top:2%;" class="row"> <div style=" text-align:left; padding-left:2%, margin-top:5%;" class="col-xs-6"> <button type="submit" onclick="logout()" class="btn btn-lg btn-default">Log Out</button> </div> <div style=" text-align:right; padding-right:2%" class="col-xs-6"> <h3 style="text-align:right; display:inline" id="highscore">High Score: 0</h3> </div> </div> <div style="margin-top:15%;" class="row"> <div style=" text-align:left; padding-left:20%" class="col-xs-6"> <button type="submit" style="padding: 4% 20% 4%; font-size:200%" onclick="findGame()" class="btn btn-lg btn-default">P VS P </button> <!--this button will first check if there is a table row in room, in the same game mode as the one selected that hasnt started or ended, if there isnt it will add a new one and take the user to th searching page, --> <!--if there is a available game it will go to the countdown page and will beguin the countdown for the game to start.--> <h2><span style="padding-left:2%" class="glyphicon glyphicon-user"></span> <p style="display:inline"> </p><span style="padding-left:5%" class="glyphicon glyphicon-user"></span> </h2> </div> <div style="text-align:right; padding-right:20%" class="col-xs-6"> <button type="submit" style="padding: 4% 20% 4%; font-size:200%" onclick="loadPage(&quot;countdown&quot;)" class="btn btn-lg btn-default">P VS C</button> <!--Once this button is clicked the countdown will begin--> <h2> <span style="padding-left:5%" class="glyphicon glyphicon-user"></span> <p style="display:inline"> </p><span style="padding-left:5%; padding-right:2%;" class="glyphicon glyphicon-open"></span> </h2> </div> </div> <div style="text-align:center; margin-top:7%;" class="row"> <select style="font-size:200%;" id="modeChooser" class="selectpicker"> <option>Classic</option> <option>Same Meanings</option> <option>Gerneric Terms</option> <option>Opposites</option> </select> </div> <div style="text-align:center; margin-top:10%;" class="row"> <button type="submit" style="padding:2% 6% 2%; font-size:150%" onclick="loadleaderboard()" class="btn btn-lg btn-default">View High scores</button> </div> <div style="text-align:right; margin-top:7%; margin-right:3%;" class="row"> <button type="submit" style="padding:2% 4% 2%; font-size:150%" onclick="loadPage(&quot;rules&quot;)" class="btn btn-lg btn-default">?</button> </div>');
...
function highScoreTable(top10scores){
    $('#container').html(' <table id="highScoreTable" class="table table-bordered table-hover table-responsive" style="margin-top:10%"><thead><tr bgcolor="#ffa834"><th>Position</th><th>Username</th><th>Score</th></tr></thead></table>')
    ...
    if(firstWord){
        ...
        var x = setInterval(function() {
            ...
            if ((new Date())>=endGametime){
                ...
                $('#container').html("<div class='row', style='margin-top:2%;'><div class='col-xs-12', style=' text-align:right; padding-right:2%'><h3 style='text-align:right' id='highScoretext'> High Score: 0</h3></div></div><div class='row', style='margin-top:10%; text-align:center;'><h1 style='font-size:350%' id='gameScore'> You Scored: 0</h1></div><div class='row', style='margin-top:3%; text-align:center;'><button class='btn btn-lg btn-default', type='submit', style='padding: 4% 4% 4%; font-size:200%, ', onclick='loadPage('searching')'> Play Again</button></div><div class='row', style='margin-top:3%; text-align:center;'><button class='btn btn-lg btn-default', type='submit', style='padding: 4% 10% 4%; font-size:200%'> Home</button></div><div class='row', style='margin-top:3%; text-align:center;'> <button class='btn btn-lg btn-default', type='submit', style='padding:2% 6% 2%; font-size:150%', onclick='loadPage('leaderboard')'> View High scores </button></div>");
